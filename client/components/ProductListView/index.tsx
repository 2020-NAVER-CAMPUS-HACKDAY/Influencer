...
const fakeFetch = () => new Promise((res) => {
  const fakeProducts = new Array(30).fill(null).map(() => ({
    imageUri: `https://naver.github.io/egjs-infinitegrid/assets/image/${((Math.random() * 59) + 1).toFixed(0)}.jpg`,
    company: '꽃세상컴퍼니',
    id: 1234563,
    price: 3000,
    name: '벚꽃나무1',
...
const ProductListView: FC = () => <InfinityList loadItems={fakeFetch} ItemComponent={ProductItem}/>;
